<template>
    <div class="productItem">
      <div v-if="loader" class="productItem__loader">
        <img class="productItem__gif" src="../../assets/images/loaders/loader.gif" alt="loader">
      </div>
      <div v-else class="productItem__content">
        ...
        <div class="productItem__data">
            ...
            <div v-if="product.isFavorite" class="productItem__action" @click="deleteFavorites(product.productId)">
                <FavIcon />
            </div>
            <div v-else class="productItem__action" @click="addFavorites(product.productId)">
                <FavIconEmpty />
            </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      async addFavorites(productId) {
        this.loader = true;
        await this.$store.dispatch('favorites/addFavoritesFromProductList', { productId });
        this.loader = false;
      }
    }
  };
